...
<div>
	<button class="btn" use:popup={AccountOptions}>
		<Avatar src="https://api.dicebear.com/6.x/bottts-neutral/svg?seed=admin" width="w-10" background="bg-primary-500" />
	</button>
	<div class="card w-48 shadow-xl variant-filled-tertiary" data-popup="accountOptions">
		<div class="p-2 space-y-2">
			<nav class="list-nav">
				<ul>
					<li><a class="btn btn-md" href="/admin/profile">Profile</a></li>
				</ul>
			</nav>
