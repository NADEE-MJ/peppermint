...
RUN sudo apt-get install curl vim wget git curl micro python3 python3-psutil python-is-python3 python3-pip cargo ripgrep dnsutils net-tools tig fzf bat exa zoxide cowsay figlet lolcat -y
